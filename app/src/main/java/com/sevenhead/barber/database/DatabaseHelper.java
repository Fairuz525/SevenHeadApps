package com.sevenhead.barber.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "db_barber";
    ...
    public static final String COL_NOTELP = "notelp";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_USER + " (" + COL_USERNAME + " TEXT PRIMARY KEY, " + COL_PASSWORD +
                " TEXT, " + COL_NAME + " TEXT, " +COL_EMAIL+ " TEXT, " +COL_ALAMAT+ " TEXT, "+COL_NOTELP+")");
        ...
        db.execSQL("insert into " + TABLE_USER + " values ('faiq@gmail.com','1234','Muhammad Fairuz','Faiq','Jember','081335515537');");
    }
    ...
    public boolean Register(String username, String password, String name, String email, String alamat, String notelp) throws SQLException {

        @SuppressLint("Recycle") Cursor mCursor = db.rawQuery("INSERT INTO " + TABLE_USER + "(" + COL_USERNAME + ", " + COL_PASSWORD + ", " + COL_NAME + ", "+COL_EMAIL+", "+COL_ALAMAT+", "+COL_NOTELP+") VALUES (?,?,?,?,?,?)", new String[]{username, password, name, email, alamat, notelp});
        if (mCursor != null) {
