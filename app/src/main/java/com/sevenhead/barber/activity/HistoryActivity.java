...
import com.sevenhead.barber.model.HistoryModel;
import com.sevenhead.barber.adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking untuk pelayanan di " + asal + " berupa layanan " + tujuan + " pada tanggal " + tanggal + ".";
